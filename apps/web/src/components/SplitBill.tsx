    ...
    const renderStep2Review = () => {
        return (
            ...
            >
                ...
                <div className="flex-1 bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-soft border border-slate-100 dark:border-white/5 flex flex-col">
    ...
    const renderStep4Result = () => {
        ...
        return (
            ...
            >
                ...
                <div
                    ref={resultRef}
                    className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl p-6 md:p-10 shadow-xl border border-slate-100 dark:border-white/5 relative overflow-hidden"
                >
