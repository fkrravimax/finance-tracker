                    ...
                    <div className="flex flex-col gap-8 h-full pt-28 md:pt-0">
                        ...
                        <nav className="flex flex-col gap-3">
                            {mainNavItems.map((item) => (
                                <motion.div key={item.id} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.96 }} className="w-full">
                                    <NavLink
                                        to={`/${item.id}`}
                                        onClick={() => {
                                        ...
                                        className={({ isActive }) => `flex items-center gap-4 px-5 py-4 rounded-2xl transition-all w-full text-left font-bold ${isActive
                                            ...
                                            : 'hover:bg-lavender-100 dark:hover:bg-lavender-100 text-slate-500 hover:text-primary dark:text-text-muted dark:hover:text-primary transition-colors'}`}
                                    >
                                        {() => (
                                            <>
