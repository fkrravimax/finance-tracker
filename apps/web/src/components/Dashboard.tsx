...
const Dashboard: React.FC = () => {
    ...
    return (
        <PageTransition>
            <StaggerContainer className="max-w-7xl mx-auto w-full p-4 md:p-6 lg:p-8 flex flex-col gap-8">
                <OnboardingModal
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <StaggerItem className="w-full">
                        <div className="h-full flex flex-col justify-between rounded-bubbly p-8 bg-sky-dark dark:bg-sky-900/50 text-white shadow-lg shadow-sky-200 dark:shadow-none relative overflow-hidden group hover:scale-[1.01] transition-transform duration-300">
                    ...
                    <StaggerItem className="w-full">
                        <div className="h-full flex flex-col justify-center rounded-bubbly p-8 bg-white dark:bg-surface-dark border border-slate-100 dark:border-white/5 shadow-card relative overflow-hidden group hover:scale-[1.01] transition-transform duration-300">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    <StaggerItem className="xl:col-span-1 border rounded-3xl h-full border-transparent">
                        <CashFlowChart income={stats?.income || 0} expense={stats?.expense || 0} transactions={transactions} />
                    </StaggerItem>
                    <StaggerItem className="xl:col-span-2 border rounded-3xl h-full border-transparent">
