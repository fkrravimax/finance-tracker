                ...
                <AnimatePresence>
                    {unreadCount > 0 && (
                        <motion.span
                            ...
                            animate={{ scale: 1 }}
                            exit={{ scale: 0 }}
                            className="absolute top-2 right-2 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white dark:border-[#1a160b]"
                        />
                    )}
                </AnimatePresence>
            </button>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute right-0 top-12 w-[85vw] max-w-[320px] bg-white dark:bg-[#1a160b] rounded-2xl shadow-xl border border-slate-100 dark:border-white/10 z-50 overflow-hidden origin-top-right"
                        >
