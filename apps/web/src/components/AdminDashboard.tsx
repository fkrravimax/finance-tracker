    ...
    if (loading) {
        return (
            <div className="p-6 max-w-7xl mx-auto space-y-6">
                {/* Skeleton Header */}
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 animate-pulse">
                ...
                {/* Skeleton Table */}
                {/* Skeleton Table (Desktop) & Cards (Mobile) */}
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden h-[600px]">

                    {/* Desktop Skeleton - Table View */}
                    <div className="hidden md:block">
                        <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex gap-4">
                            {/* Header Skeleton */}
                            <div className="w-[35%] h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                            <div className="w-[18%] h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                            <div className="w-[18%] h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                            <div className="w-[18%] h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                            <div className="w-[11%] h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                        </div>
                        <div className="p-4 space-y-4">
                            {[...Array(8)].map((_, i) => (
                                <div key={`desktop-${i}`} className="flex items-center gap-4 animate-pulse">
                                    ...
                                    <div className="w-[18%] h-6 bg-gray-200 dark:bg-gray-700 rounded-full"></div>
                                    <div className="w-[18%] h-4 bg-gray-200 dark:bg-gray-700 rounded"></div>
                    ...
                    <div className="md:hidden p-4 space-y-4">
                        {[...Array(6)].map((_, i) => (
                            <div key={`mobile-${i}`} className="space-y-3 animate-pulse border-b border-gray-100 dark:border-gray-700 pb-4 last:border-0">
