    ...
    if (loading) {
        return (
            <div className="p-6 max-w-7xl mx-auto space-y-6 animate-pulse">
                {/* Broadcast Section Skeleton */}
                <div className="h-64 bg-gray-200 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700"></div>
                ...
                {/* Search Bar Skeleton */}
                <div className="h-12 w-full bg-gray-200 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700"></div>
                ...
                {/* Skeleton Table/Cards Container */}
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden h-[600px]">
                                ...
                                {[...Array(8)].map((_, i) => (
                                    <tr key={`desktop-${i}`}>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="w-8 h-8 mx-auto bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
                    ...
                    <div className="md:hidden p-4 space-y-4">
                        {[...Array(6)].map((_, i) => (
                            <div key={`mobile-${i}`} className="space-y-3 border-b border-gray-100 dark:border-gray-700 pb-4 last:border-0">
