...
app.use(cors({
    origin: process.env.FRONTEND_URL ? [process.env.FRONTEND_URL, "https://finance-web-five-coral.vercel.app", "https://financetrx.vercel.app", "http://localhost:5173", "http://localhost:5174"] : ["https://financetrx.vercel.app", "http://localhost:5173", "http://localhost:5174"],
    credentials: true,
